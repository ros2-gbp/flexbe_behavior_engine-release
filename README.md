## flexbe_behavior_engine (lyrical) - 4.1.4-1

The packages in the `flexbe_behavior_engine` repository were released into the `lyrical` distro by running `/usr/bin/bloom-release --new-track --track lyrical --rosdistro lyrical flexbe_behavior_engine` on `Sat, 16 May 2026 18:59:37 -0000`
...
## flexbe_behavior_engine (rolling) - 4.1.4-1

The packages in the `flexbe_behavior_engine` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --new-track --track rolling --rosdistro rolling flexbe_behavior_engine` on `Sat, 16 May 2026 18:55:36 -0000`
...
## flexbe_behavior_engine (kilted) - 4.1.4-1

The packages in the `flexbe_behavior_engine` repository were released into the `kilted` distro by running `/usr/bin/bloom-release --new-track --track kilted --rosdistro kilted flexbe_behavior_engine` on `Sat, 16 May 2026 18:52:18 -0000`
...
## flexbe_behavior_engine (lyrical) - 4.1.3-1

The packages in the `flexbe_behavior_engine` repository were released into the `lyrical` distro by running `/usr/bin/bloom-release --new-track --track lyrical --rosdistro lyrical flexbe_behavior_engine --edit` on `Tue, 12 May 2026 00:31:39 -0000`
...
## flexbe_behavior_engine (rolling) - 4.1.3-1

The packages in the `flexbe_behavior_engine` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --new-track --track rolling --rosdistro rolling flexbe_behavior_engine --edit` on `Tue, 12 May 2026 00:28:03 -0000`
...
## flexbe_behavior_engine (kilted) - 4.1.3-1

The packages in the `flexbe_behavior_engine` repository were released into the `kilted` distro by running `/usr/bin/bloom-release --new-track --track kilted --rosdistro kilted flexbe_behavior_engine --edit` on `Tue, 12 May 2026 00:24:43 -0000`
...
## flexbe_behavior_engine (rolling) - 4.0.3-1

The packages in the `flexbe_behavior_engine` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --new-track --track rolling --rosdistro rolling flexbe_behavior_engine` on `Mon, 10 Nov 2025 17:01:17 -0000`
...
## flexbe_behavior_engine (rolling) - 4.0.2-1

The packages in the `flexbe_behavior_engine` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --new-track --track rolling --rosdistro rolling flexbe_behavior_engine` on `Sat, 08 Nov 2025 23:24:37 -0000`
...
## flexbe_behavior_engine (kilted) - 4.0.2-1

The packages in the `flexbe_behavior_engine` repository were released into the `kilted` distro by running `/usr/bin/bloom-release --new-track --track kilted --rosdistro kilted flexbe_behavior_engine` on `Sat, 08 Nov 2025 23:20:31 -0000`
...
## flexbe_behavior_engine (jazzy) - 3.0.7-1

The packages in the `flexbe_behavior_engine` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release --new-track --track jazzy --rosdistro jazzy flexbe_behavior_engine` on `Sat, 08 Nov 2025 23:05:34 -0000`
...
## flexbe_behavior_engine (rolling) - 3.0.3-1

The packages in the `flexbe_behavior_engine` repository were released into the `rolling` distro by running `/usr/local/bin/bloom-release --new-track --track rolling --rosdistro rolling flexbe_behavior_engine` on `Thu, 06 Jun 2024 18:32:40 -0000`
...
## flexbe_behavior_engine (iron) - 3.0.2-1

The packages in the `flexbe_behavior_engine` repository were released into the `iron` distro by running `/usr/local/bin/bloom-release --new-track --track iron --rosdistro iron flexbe_behavior_engine` on `Thu, 06 Jun 2024 16:35:09 -0000`
...
## flexbe_behavior_engine (humble) - 2.3.4-1

The packages in the `flexbe_behavior_engine` repository were released into the `humble` distro by running `/usr/local/bin/bloom-release --new-track --track humble --rosdistro humble flexbe_behavior_engine` on `Wed, 01 May 2024 21:06:16 -0000`
...
## flexbe_behavior_engine (iron) - 3.0.0-1

The packages in the `flexbe_behavior_engine` repository were released into the `iron` distro by running `/usr/bin/bloom-release --new-track --track iron --rosdistro iron flexbe_behavior_engine` on `Wed, 01 May 2024 20:24:38 -0000`
...
## flexbe_behavior_engine (iron) - 2.3.3-1

The packages in the `flexbe_behavior_engine` repository were released into the `iron` distro by running `/usr/bin/bloom-release --new-track --rosdistro iron --track iron flexbe_behavior_engine` on `Thu, 10 Aug 2023 18:14:39 -0000`
...
## flexbe_behavior_engine (humble) - 2.3.3-1

The packages in the `flexbe_behavior_engine` repository were released into the `humble` distro by running `/usr/bin/bloom-release --new-track --rosdistro humble --track humble flexbe_behavior_engine` on `Thu, 10 Aug 2023 18:08:17 -0000`
